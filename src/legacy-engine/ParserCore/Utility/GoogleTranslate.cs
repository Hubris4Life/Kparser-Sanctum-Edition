...
namespace WaywardGamers.KParser.Utility
{
    ...
    // The inherited Google AJAX translation endpoint and embedded key are obsolete.
    // Keep the compatibility surface, but do not transmit chat to that service.
    ...
    public class Translator
    {
        ...
        private static readonly string KParserAPIKey = string.Empty;
